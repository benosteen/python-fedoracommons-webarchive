...
_magic_number = 2
_modified_time = 1206898304.3580079
_template_filename='/home/archive/archive/archive/templates/type/trackback.mak'
_template_uri='/type/trackback.mak'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        context.write(u'">Trackback to this item</a>\n</div><div id="relationships">\n')
        # SOURCE LINE 23
...
def render_title_text(context):
    ...
    try:
        ...
        if c.title:
            # SOURCE LINE 5
            context.write(u'<title> Trackback: "')
            context.write(filters.decode.utf8(c.title))
            context.write(u'" - ')
            context.write(filters.decode.utf8(c.id))
