...
_magic_number = 2
_modified_time = 1206014936.4243791
_template_filename='/home/archive/archive/archive/templates/type/general.mak'
_template_uri='/type/general.mak'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        if c.title:
            # SOURCE LINE 14
            context.write(u'<p> ORA General Item: <strong>"')
            context.write(filters.decode.utf8(c.title))
            context.write(u'"</strong></p>\n')
            # SOURCE LINE 15
        elif c.id:
            # SOURCE LINE 16
            context.write(u'<p> ORA General Item: ')
...
def render_title_text(context):
    ...
    try:
        ...
        if c.title:
            # SOURCE LINE 5
            context.write(u'<title> ORA General Item: "')
            context.write(filters.decode.utf8(c.title))
            context.write(u'" - ')
            context.write(filters.decode.utf8(c.id))
