...
_magic_number = 2
_modified_time = 1205933419.588043
_template_filename='/home/archive/archive/archive/templates/type/thesis.mak'
_template_uri='/type/thesis.mak'
...
def render_title_text(context):
    ...
    try:
        ...
        if c.title:
            # SOURCE LINE 5
            context.write(u'<title> ORA Thesis: "')
            context.write(filters.decode.utf8(c.title))
            context.write(u'" - ')
            context.write(filters.decode.utf8(c.id))
