...
_magic_number = 2
_modified_time = 1207140616.9172411
_template_filename='/home/ben/Desktop/archive/archive/templates/type/basic.mak'
_template_uri='/type/basic.mak'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        if c.title:
            # SOURCE LINE 14
            context.write(u'<p> ORA Basic Item: <strong>"')
            context.write(filters.decode.utf8(c.title))
            context.write(u'"</strong></p>\n')
            # SOURCE LINE 15
        elif c.id:
            # SOURCE LINE 16
            context.write(u'<p> ORA Basic Item: ')
...
def render_title_text(context):
    ...
    try:
        ...
        if c.title:
            # SOURCE LINE 5
            context.write(u'<title> ORA Basic Item: "')
            context.write(filters.decode.utf8(c.title))
            context.write(u'" - ')
            context.write(filters.decode.utf8(c.id))
